...
public class Activity_AsyncScanHeartRateSampler extends Activity_HeartRateDisplayBase{
    private String tag = "Activity_AsyncScanHeartRateSampler";
    protected boolean mainIsShowing = false;

    TextView mTextView_Status;
    ArrayList<AsyncScanResultDeviceInfo> mAlreadyConnectedDeviceInfos;
    ArrayList<AsyncScanResultDeviceInfo> mScannedDeviceInfos;
    ...
    protected void initScanDisplay()
    {
        ...
        mScannedDeviceInfos = new ArrayList<AsyncScanResultDeviceInfo>();
        ...
        hrScanCtrl = AntPlusHeartRatePcc.requestAsyncScanController(this, 0,
                new IAsyncScanResultReceiver() {
                    ...
                    public void onSearchStopped(RequestAccessResult reasonStopped) {
                        Log.d(tag, "onSearchStopped, reason :" + reasonStopped.toString());

                        if(reasonStopped.toString().equals("DEPENDENCY_NOT_INSTALLED")){
                            Log.d(tag, "Zariadenie nepodporuje ANT+ !");
                            return;
                        }
                    ...
                    public void onSearchResult(final AsyncScanResultDeviceInfo deviceFound) {
                        Log.d(tag, "onSearchResult, deviceFound :" + deviceFound.toString());
