...
public class Session {
	 ...
	 */
	public void setSurfaceView(final MySurfaceView view) {
	 ...
	 * You should of course pass a {@link MySurfaceView} to {@link #setSurfaceView(MySurfaceView)}
	...
	/*
	public void stopOnlyCameraPreview(){
		mHandler.post(new Runnable() {
			@Override
			public void run() {
				if (mVideoStream != null) {
					mVideoStream.stopOnlyCameraPreview();
				}
			}
		});
	}
