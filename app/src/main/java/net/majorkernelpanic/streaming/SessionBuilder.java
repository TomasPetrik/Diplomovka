...
public class SessionBuilder {
	...
	public Session build() {
		...
		if (session.getVideoTrack()!=null) {
			...
			video.setSurfaceView(mMySurfaceView);
	 ...
	 **/
	public SessionBuilder setSurfaceView(MySurfaceView mySurfaceView) {
	...
	/** Returns the SurfaceView set with {@link #setSurfaceView(MySurfaceView)}. */
	public MySurfaceView getSurfaceView() {
		return mMySurfaceView;
	}
