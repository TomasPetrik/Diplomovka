...
JNIEXPORT int Java_com_pop24_androidapp_MainActivity_pixeltobmp( JNIEnv* env,jobject thiz,
...
JNIEXPORT void Java_com_pop24_androidapp_MainActivity_freeCameraMemory( JNIEnv* env,jobject thiz){
